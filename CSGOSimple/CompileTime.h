...
constexpr int CONV_STR2DEC_1(const char str[], int i)
{
	return str[i] > '0' ? str[i] - '0' : 0;
}
constexpr int CONV_STR2DEC_2(const char str[], int i)
{
	return CONV_STR2DEC_1(str, i) * 10 + str[i+1] - '0';
}
constexpr int CONV_STR2DEC_3(const char str[], int i)
{
	return CONV_STR2DEC_2(str, (i)) * 10 + str[(i)+2] - '0';
}
constexpr int CONV_STR2DEC_4(const char str[], int i)
{
	return CONV_STR2DEC_3(str, (i)) * 10 + str[(i)+3] - '0';
}

// Some definitions for calculation
constexpr unsigned long SEC_PER_MIN = 60UL;
constexpr unsigned long SEC_PER_HOUR = 3600UL;
constexpr unsigned long SEC_PER_DAY = 86400UL;
constexpr unsigned long SEC_PER_YEAR = SEC_PER_DAY * 365;
constexpr unsigned long UNIX_START_YEAR = 1970UL;
