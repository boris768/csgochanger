...
namespace md5 {
     ...
     */
    inline unsigned int cyclic_left_rotate(const unsigned int data, const unsigned int shift_bits) {
        return (data << shift_bits) | (data >> (32 - shift_bits));
    }

    inline unsigned int F(const unsigned int x, const unsigned int y, const unsigned int z) {return (x & y) | (~x & z);};
    inline unsigned int G(const unsigned int x, const unsigned int y, const unsigned int z) {return (x & z) | (y & ~z);};
    inline unsigned int H(const unsigned int x, const unsigned int y, const unsigned int z) {return x ^ y ^ z;};
    inline unsigned int I(const unsigned int x, const unsigned int y, const unsigned int z) {return y ^ (x | ~z);};

    inline void FF(unsigned int &a, const unsigned int b, const unsigned int c, const unsigned int d, const unsigned int Xk, const unsigned int s, const unsigned int i) {
        #if MD5_DEBUG
            std::cout << "\nA: " << a << "\nB: " << b << "\nC: " << c << "\nD: " << d << "\nX[" << i << "]: " << Xk << "\ns: " << S1[s] << "\nT: " << T[i] << "\n";
        #endif
    ...
    inline void GG(unsigned int &a, const unsigned int b, const unsigned int c, const unsigned int d, const unsigned int Xk, const unsigned int s, const unsigned int i) {
        #if MD5_DEBUG
            std::cout << "\nA: " << a << "\nB: " << b << "\nC: " << c << "\nD: " << d << "\nX[" << i - 16 << "]: " << Xk << "\ns: " << S2[s] << "\nT: " << T[i] << "\n";
        #endif // MD5_DEBUG
    ...
    inline void HH(unsigned int &a, const unsigned int b, const unsigned int c, const unsigned int d, const unsigned int Xk, const unsigned int s, const unsigned int i) {
        #if MD5_DEBUG
            std::cout << "\nA: " << a << "\nB: " << b << "\nC: " << c << "\nD: " << d << "\nX[" << i - 32 << "]: " << Xk << "\ns: " << S3[s] << "\nT: " << T[i] << "\n";
        #endif // MD5_DEBUG
    ...
    inline void II(unsigned int &a, const unsigned int b, const unsigned int c, const unsigned int d, const unsigned int Xk, const unsigned int s, const unsigned int i) {
        #if MD5_DEBUG
            std::cout << "\nA: " << a << "\nB: " << b << "\nC: " << c << "\nD: " << d << "\nX[" << i - 48 << "]: " << Xk << "\ns: " << S4[s] << "\nT: " << T[i] << "\n";
        #endif // MD5_DEBUG
