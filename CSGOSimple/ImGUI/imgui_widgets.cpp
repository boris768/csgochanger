...
#else
static constexpr ImS64          IM_S64_MIN = -9223372036854775807LL - 1;
static constexpr ImS64          IM_S64_MAX = 9223372036854775807LL;
#endif
static constexpr ImU64          IM_U64_MIN = 0;
#ifdef ULLONG_MAX
static constexpr ImU64          IM_U64_MAX = ULLONG_MAX; // (0xFFFFFFFFFFFFFFFFull);
#else
static constexpr ImU64          IM_U64_MAX = (2ULL * 9223372036854775807LL + 1);
#endif
...
static void ImGui::TabBarLayout(ImGuiTabBar* tab_bar)
{
    ...
    for (int tab_n = 0; tab_n < tab_bar->Tabs.Size; tab_n++)
    {
		...
		auto current_ShrinkWidthBuffer = &g.ShrinkWidthBuffer[tab_n];
		current_ShrinkWidthBuffer->Index = tab_n;
		current_ShrinkWidthBuffer->Width = tab->WidthContents;
    }
