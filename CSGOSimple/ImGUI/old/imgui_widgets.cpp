...
constexpr signed char    IM_S8_MIN  = -128;
constexpr signed char    IM_S8_MAX  = 127;
constexpr unsigned char  IM_U8_MIN  = 0;
constexpr unsigned char  IM_U8_MAX  = 0xFF;
constexpr signed short   IM_S16_MIN = -32768;
constexpr signed short   IM_S16_MAX = 32767;
constexpr unsigned short IM_U16_MIN = 0;
constexpr unsigned short IM_U16_MAX = 0xFFFF;
constexpr ImS32          IM_S32_MIN = INT_MIN;    // (-2147483647 - 1), (0x80000000);
constexpr ImS32          IM_S32_MAX = INT_MAX;    // (2147483647), (0x7FFFFFFF)
constexpr ImU32          IM_U32_MIN = 0;
constexpr ImU32          IM_U32_MAX = UINT_MAX;   // (0xFFFFFFFF)
#ifdef LLONG_MIN
constexpr ImS64          IM_S64_MIN = LLONG_MIN;  // (-9223372036854775807ll - 1ll);
constexpr ImS64          IM_S64_MAX = LLONG_MAX;  // (9223372036854775807ll);
#else
constexpr ImS64          IM_S64_MIN = -9223372036854775807LL - 1;
constexpr ImS64          IM_S64_MAX = 9223372036854775807LL;
#endif
constexpr ImU64          IM_U64_MIN = 0;
#ifdef ULLONG_MAX
constexpr ImU64          IM_U64_MAX = ULLONG_MAX; // (0xFFFFFFFFFFFFFFFFull);
#else
constexpr ImU64          IM_U64_MAX = (2ULL * 9223372036854775807LL + 1);
#endif
...
bool ImGui::DragBehaviorT(ImGuiDataType data_type, TYPE* v, float v_speed, const TYPE v_min, const TYPE v_max, const char* format, float power, ImGuiDragFlags flags)
{
	...
	const bool is_already_past_limits_and_pushing_outward = has_min_max && ((*v >= v_max && adjust_delta > 0.0f) || (*v <= v_min && adjust_delta < 0.0f));
...
bool ImGui::MenuItem(const char* label, const char* shortcut, bool selected, bool enabled)
{
    ...
    {
	    const ImVec2 shortcut_size = shortcut ? CalcTextSize(shortcut, nullptr) : ImVec2(0.0f, 0.0f);
