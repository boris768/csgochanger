...
LPDIRECT3DTEXTURE9       g_FontTexture = nullptr;
...
static void ImGui_ImplDX9_SetupRenderState(ImDrawData* draw_data)
{
    ...
    g_pd3dDevice->SetRenderState(D3DRS_FOGENABLE, 0);
	...
	g_pd3dDevice->GetRenderState(D3DRS_COLORWRITEENABLE, &dwOld_D3DRS_COLORWRITEENABLE);
	g_pd3dDevice->SetRenderState(D3DRS_COLORWRITEENABLE, 0xffffffff);
	g_pd3dDevice->SetRenderState(D3DRS_SRGBWRITEENABLE, 0);
...
void ImGui_ImplDX9_RenderDrawData(ImDrawData* draw_data)
{
    ...
    if (!g_pIB || g_IndexBufferSize < draw_data->TotalIdxCount)
    {
        ...
        if (g_pd3dDevice->CreateIndexBuffer(g_IndexBufferSize * sizeof(ImDrawIdx), D3DUSAGE_DYNAMIC | D3DUSAGE_WRITEONLY, fmt, D3DPOOL_DEFAULT, &g_pIB, nullptr) < 0)
            return;
    }
    ...
    for (int n = 0; n < draw_data->CmdListsCount; n++)
    {
        ...
        for (int cmd_i = 0; cmd_i < cmd_list->CmdBuffer.Size; cmd_i++)
        {
            ...
            else
            {
                ...
                const auto texture = (LPDIRECT3DTEXTURE9)pcmd->TextureId;
	...
	g_pd3dDevice->SetRenderState(D3DRS_COLORWRITEENABLE, dwOld_D3DRS_COLORWRITEENABLE);
	g_pd3dDevice->SetRenderState(D3DRS_SRGBWRITEENABLE, 1);
