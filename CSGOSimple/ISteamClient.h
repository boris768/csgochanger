...
extern "C" typedef void(*SteamAPI_PostAPIResultInProcess_t)(SteamAPICall_t callHandle, void *, __int32 unCallbackSize, int iCallbackNum);
extern "C" typedef __int32(*SteamAPI_CheckCallbackRegistered_t)(int iCallbackNum);
...
public:
    ...
    virtual void SetLocalIPBinding(__int32 unIP, __int16 usPort) = 0;
    ...
    virtual __int32 GetIPCCallCount() = 0;
