...
namespace SourceEngine
{
    ...
    struct Ray_t
    {
        ...
        void Init(Vector const& start, Vector const& end)
        {
            ...
            m_IsSwept = fabs(m_Delta.LengthSqr()) > FLT_EPSILON;
        ...
        Vector InvDelta() const
        {
            ...
            for(int iAxis = 0; iAxis < 3; ++iAxis) {				
                if(fabs(m_Delta[iAxis]) > FLT_EPSILON) {
    ...
    public:
        ...
        CBaseTrace()
        {
			memset(this, 0, sizeof(CBaseTrace));
        }
    ...
    public:
		...
		CGameTrace& operator=(const CGameTrace& in)
		{
			memcpy(this, &in, sizeof(CGameTrace));
			return *this;
		}
