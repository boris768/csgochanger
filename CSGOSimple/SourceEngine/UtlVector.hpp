...
namespace SourceEngine
{
	...
	protected:
		...
		CUtlVector(CUtlVector const& vec): m_Size(0), m_pElements(nullptr)
		{
			Assert(0);
		}
	...
	CUtlVector<T, A>::CUtlVector(int growSize, int initSize) :
	...
	template <typename T, class A>
	T& CUtlVector<T, A>::Element(int i)
	{
		Assert(i < m_Size);
		return m_Memory[i];
	}
	...
	template <typename T, class A>
	const T& CUtlVector<T, A>::Element(int i) const
	{
		Assert(i < m_Size);
		return m_Memory[i];
	}
	...
	//-----------------------------------------------------------------------------
	template <typename T, class A>
	int CUtlVector<T, A>::Count() const
	{
		return m_Size;
	}
	...
	//-----------------------------------------------------------------------------
	template <typename T, class A>
	bool CUtlVector<T, A>::IsValidIndex(int i) const
	{
		return (i >= 0) && (i < m_Size);
	}
	...
	//-----------------------------------------------------------------------------
	template <typename T, class A>
	int CUtlVector<T, A>::InvalidIndex()
	{
		return -1;
	}
	...
	//-----------------------------------------------------------------------------
	template <typename T, class A>
	int CUtlVector<T, A>::AddToHead()
	{
		return InsertBefore(0);
	}

	template <typename T, class A>
	int CUtlVector<T, A>::AddToTail()
	{
		return InsertBefore(m_Size);
	}

	template <typename T, class A>
	int CUtlVector<T, A>::InsertAfter(int elem)
	{
	...
	//-----------------------------------------------------------------------------
	template <typename T, class A>
	int CUtlVector<T, A>::AddToHead(const T& src)
	{
	...
	template <typename T, class A>
	int CUtlVector<T, A>::AddToTail(const T& src)
	{
		// Can't insert something that's in the list... reallocation may hose us
		Assert((Base() == NULL) || (&src < Base()) || (&src >= (Base() + Count())));
	...
	template <typename T, class A>
	int CUtlVector<T, A>::InsertAfter(int elem, const T& src)
	{
		// Can't insert something that's in the list... reallocation may hose us
		Assert((Base() == NULL) || (&src < Base()) || (&src >= (Base() + Count())));
	...
	//-----------------------------------------------------------------------------
	template <typename T, class A>
	int CUtlVector<T, A>::AddMultipleToHead(int num)
	{
		return InsertMultipleBefore(0, num);
	}

	template <typename T, class A>
	int CUtlVector<T, A>::AddMultipleToTail(int num)
	{
		return InsertMultipleBefore(m_Size, num);
	}

	template <typename T, class A>
	int CUtlVector<T, A>::AddMultipleToTail(int num, const T* pToCopy)
	{
		// Can't insert something that's in the list... reallocation may hose us
	...
	template <typename T, class A>
	void CUtlVector<T, A>::SetSize(int size)
	{
		SetCount(size);
	}
	...
	template <typename T, class A>
	int CUtlVector<T, A>::InsertMultipleBefore(int elem, int num)
	{
		if (num == 0)
			return elem;
	...
	template <typename T, class A>
	int CUtlVector<T, A>::InsertMultipleBefore(int elem, int num, const T* pToInsert)
	{
		if (num == 0)
			return elem;
	...
	template <typename T, class A>
	void CUtlVector<T, A>::PurgeAndDeleteElements()
	{
	...
	template <typename T, class A>
	void CUtlVector<T, A>::Compact()
	{
		m_Memory.Purge(m_Size);
	}

	template <typename T, class A>
	int CUtlVector<T, A>::NumAllocated() const
	{
