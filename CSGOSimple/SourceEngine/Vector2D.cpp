...
namespace SourceEngine
{
    ...
    Vector2D::Vector2D(const vec_t* clr)
    {
        x = clr[0]; y = clr[1];
    }
    ...
    vec_t& Vector2D::operator[](size_t i)
    {
        return reinterpret_cast<vec_t*>(this)[i];
    }

    vec_t Vector2D::operator[](size_t i) const
    {
        return ((float*)this)[i];
    }
