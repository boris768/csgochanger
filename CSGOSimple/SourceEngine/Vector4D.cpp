...
namespace SourceEngine
{
    ...
    // Array access
    //-----------------------------------------------------------------------------
    vec_t& Vector4D::operator[](unsigned int  i)
    {
        return ((vec_t*)this)[i];
    }

    vec_t Vector4D::operator[](unsigned int  i) const
    {
        return ((vec_t*)this)[i];
    }
    ...
    {
        return !isinfinite2(x) && !isinfinite2(y) && !isinfinite2(z) && isinfinite2(w);
    }
