...
constexpr auto NUM_ENT_ENTRY_BITS = 16;
...
namespace SourceEngine
{
    ...
    public:
        constexpr CBaseHandle() noexcept : m_Index(INVALID_EHANDLE_INDEX){}
    ...
    {
        CHandle<T> ret;
        ret.m_Index = static_cast<unsigned long>(index);
        return ret;
    }
    ...
    {
	    const unsigned long otherIndex = (pEntity) ? pEntity->GetRefEHandle().m_Index : INVALID_EHANDLE_INDEX;
