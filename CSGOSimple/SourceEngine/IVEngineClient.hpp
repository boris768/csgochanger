...
namespace SourceEngine
{
	...
	public:
		...
		virtual void                  Mat_Stub(/*IMaterialSystem*/ void *pMatSys) = 0; // 50
		...
		virtual bool                  REMOVED_SteamRefreshLogin(const char *password, bool isSecure) = 0; // 102
		...
		virtual void                  ClientCmd_Unrestricted(const char *szCmdString, bool bDelayed = false) = 0; // 114
		virtual void                  ClientCmd_Unrestricted(char  const*, int, bool) = 0;
		virtual void                  SetRestrictServerCommands(bool bRestrict) = 0; //115
		virtual void                  SetRestrictClientCommands(bool bRestrict) = 0;
		virtual void                  SetOverlayBindProxy(int iOverlayID, void *pBindProxy) = 0;
		virtual bool                  CopyFrameBufferToMaterial(const char *pMaterialName) = 0;
		virtual void                  ReadConfiguration(const int iController, const bool readDefault) = 0;
		virtual void                  SetAchievementMgr(IAchievementMgr *pAchievementMgr) = 0; //120
		...
		virtual char* const           GetSaveDirName() = 0; // 132
		...
		virtual bool                  LoadFilmmaker() = 0; // 150
		virtual void                  UnloadFilmmaker() = 0; //151
		...
		virtual void                  SetMixLayerLevel(int index, float level) = 0; //160
		...
		virtual   const char*         Key_LookupBindingEx(const char *pBinding, int iUserId = -1, int iStartCount = 0, int iAllowJoystick = -1) = 0; // 170
		...
		virtual bool                  IsInCommentaryMode() = 0; //179 
		...
		virtual CSteamAPIContext*     GetSteamAPIContext() = 0; //185
		...
		virtual void                  ServerCmdKeyValues(KeyValues *pKeyValues) = 0; //187
		...
		//185
		//HACK: repair engine vtable
		//CSteamAPIContext* GetSteamAPIContext2()
		//{
		//	return CallVFunction<CSteamAPIContext*( __cdecl*)()>(this, 185)();
		//}
		////187
		//void ServerCmdKeyValues2(KeyValues *pKeyValues)
		//{
		//	return CallVFunction<void(__cdecl*)(KeyValues *)>(this, 187)(pKeyValues);
		//}
	};
}
